...
export class Centro extends Objeto3D {
    constructor() {
        ...
        this.columnas = 3
        var puntosCurva = []
        this.curvaPendiente = new BezierCubica([[23,-5,0],[22.01,-3.35,0],[21.02,-1.7,0],[20,0,0]], "z")
        this.curvaCentro = new BezierCubica([[20,0,0],[10,0,0],[5,0,0],[0,0,0]], "z")
        const puntosPendiente = discretizar(this.curvaPendiente, 1, false)
